...
namespace Domain.Interfaces.Method
{
    ...
    {
        public Task<TransaccionEntity> actualizarPerfil(int perfil_id, string perfil, string descripcion, int usuario_id, int? sistemaId);

        public Task<TransaccionEntity> eliminarPerfil(int perfil_id, int usuario_id);

        public Task<TransaccionEntity> registrarPerfil(string perfil, string descripcion, int usuario_id, int? sistemaId);
